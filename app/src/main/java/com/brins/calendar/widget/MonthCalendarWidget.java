...
package com.brins.calendar.widget;
...
import com.brins.calendar.MainActivity;
...
public class MonthCalendarWidget extends AppWidgetProvider {
    private static final String ACTION_PREVIOUS_MONTH
            = "com.brins.calendar.action.PREVIOUS_MONTH";
    private static final String ACTION_NEXT_MONTH
            = "com.brins.calendar.action.NEXT_MONTH";
    private static final String ACTION_RESET_MONTH
            = "com.brins.calendar.action.RESET_MONTH";
    private static final String ACTION_START_MAINACTIVITY
            = "com.brins.calendar.action.";
    ...
    private void drawWidget(Context context, int appWidgetId) {
        ...
        rv.setOnClickPendingIntent(R.id.calendar,PendingIntent.getActivity(context,0,new Intent(context, MainActivity.class)
                ,PendingIntent.FLAG_UPDATE_CURRENT));
